...
const ModifyItemScreen: screenComponent = ({
  navigation,
  formNameChanged,
  formQuantityChanged,
  formPriceChanged,
    ...
    >
      ...
      <TouchableHighlight
        onPress={() => {          
          ...
          if (validated) {
            modifyPantryItem(
              { name, price, quantity, expirationDate, id: itemToEditId},
              currentGroup
            );
        ...
        style={submitButton}
      >
        <Text style={submitButtonText}>Edit</Text>
      </TouchableHighlight>
    </View>
  );
};
...
ModifyItemScreen.navigationOptions = {
  title: null,
  headerStyle: {
